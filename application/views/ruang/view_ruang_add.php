          ...
          <form action="<?= $url_submit; ?>" method="post" class="form-horizontal form-label-left" novalidate>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-2 col-sm-2 col-xs-12">
                <input type="text" name="kode" class="form-control input-sm col-md-3 col-xs-12" placeholder="kode ruang" required="required" value="<?=$data['kode']?>">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-2 col-sm-4 col-xs-12">
                <input type="text" name="nama" class="form-control input-sm col-md-5 col-xs-12" placeholder="nama ruang" required="required" value="<?=$data['nama']?>">
              </div>
            </div>

            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Prodi <span class="required">*</span></label>
              <div class="col-md-3 col-sm-2 col-xs-15">
              <select class="form-control input-sm col-md-5 col-xs-12" name="prodi">
                    <option>--Pilih Prodi--</option>
                <?php foreach ($prodinm as $key => $nm) {?>
            ...
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Ruang Praktikum <span class="required">*</span></label>
              <div class="col-md-2 col-sm-2 col-xs-12">
                <?=$rd_iscad?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-md-offset-3">
                ...
                <a href="<?= $url_ruang; ?>"><button type="button" class="btn  btn-default">Kembali</button></a>
              </div>
            </div>
