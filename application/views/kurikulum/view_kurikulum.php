    ...
    <form class="form" method="post" action="<?php echo base_url() . 'pengelolaan/kurikulum_search'?>">
        ...
        <div class="col-md-4 col-sm-5 col-xs-12 form-group top_search">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button class="btn btn-default btn-info" type="submit">Cari</button>
            </span>
          </div>
        </div>
      </div>
      <div class="title_right pull-right">
        <a href="<?php echo base_url() . 'pengelolaan/kurikulum_add';?>">
          <button type="button" class="btn  btn-primary"><i class="fa fa-plus"> Data Baru </i></button>
        </a>
      </div>
    </form>
    <!--End Search Form-->
        ...
        <table class="table">
          ...
          <?php
            ...
            <tr>
              ...
              <td align="center">
              <a href="<?php echo base_url() . 'pengelolaan/kurikulum_edit/' .$kurikulum->kode;?>"><button class=" btn-warning"><i class="fa fa-edit"></i></button></a>
              <a href="<?php echo base_url() . 'pengelolaan/kurikulum_delete/' .$kurikulum->kode;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" ><button class=" btn-danger"><i class="fa fa-trash"></i></button></a>
            </td>
          </tr>
        <?php $i++;} ?>
          </tbody>
