        ...
        <div class="x_panel">
          ...
          <form action="<?=$url_submit?>" method="post" class="form-horizontal form-label-left" novalidate>
            ...
            <div class="item form-group">
              ...
              <?php
              if ($filter['id']=='') {
                echo '<a class="get_guru" href="'.$url_pilih_guru.'"><button type="button" class="btn btn-sm  btn-info">Pilih Guru</button></a>';
                }
              ?>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <a class="get_waktu" href="<?=$url_pilih_waktu?>"><button type="button" class="btn btn-sm  btn-info">Pilih waktu</button></a>
                <br><br>
                <div class="table-responsive">
                <table id="table_time" class="table">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-md-offset-3">
                ...
                <a href="<?=$url_waktu_guru?>"><button type="button" class="btn  btn-default">Kembali</button></a>
              </div>
            </div>
            <br>
