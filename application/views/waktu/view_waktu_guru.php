        ...
        if (!empty($data)) {
          foreach ($data as $key => $value) {
            ...
            <tr>
              ...
              <td><?=$value['nama']?></td>
              <td align="center">
                <a href="<?=$url_edit.'?id='.$value['id']?>" class="btn btn-xs  btn-warning"><i class="fa fa-edit"></i> Ubah </a>
                <a href="<?=$url_del.'/'.$value['id']?>" class="btn btn-xs  btn-danger" onClick="return confirm('Anda yakin ingin menghapus data ini ?')"><i class="fa fa-trash"></i> Hapus </a>
              </td>
            </tr>
            <?php
          }
