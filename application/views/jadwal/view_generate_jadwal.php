          ...
          <form action="<?=$url_submit?>" method="post" class="form-horizontal form-label-left" novalidate>
            ...
            <div class="form-group">
              <div class="col-md-4 col-md-offset-3">
                <button type="submit" class="btn  btn-primary" <?=$style?> onclick="ShowLoading()" >Generate Jadwal</button>
                <a href="<?=$url_jadwal?>"><button type="button" class="btn  btn-default">Kembali</button></a>
              </div>
            </div>
