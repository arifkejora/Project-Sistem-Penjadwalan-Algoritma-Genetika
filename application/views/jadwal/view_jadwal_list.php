<div class="">
  ...
  <div class="clearfix"></div>
    ...
    <div class="pull-right">
      <a href="<?=base_url() . 'penjadwalan/jadwal_pelajaran';?>" data-toggle="tooltip" data-placement="top" title="Kolom Jadwal" class="btn btn-sm  btn-default">
      ...
      <button class="btn btn-sm  btn-info"><i class="fa fa-file-text"></i> Laporan</button>
      </a>
      <?php } ?>
        ...
        if (!empty($data)) {
          foreach ($data as $key => $value) {
            ...
            <tr>
              ...
              <?php if ($this->session->userdata('level')=='admin') {?>
              <td align="center">
                <a href="<?=base_url('penjadwalan/jadwal_edit').'?id='.$value['id_jp']?>"><button class="btn btn-xs  btn-warning"><i class="fa fa-edit"></i> Ubah </button></a>
              </td>
              <?php } ?>
            </tr>
            <?php
