    ...
    <form method="post" action="<?php echo base_url() . 'penjadwalan/kelas'?>">
      ...
      <div class="title_right pull-right">
        <a href="<?php echo base_url() . 'penjadwalan/reset_kls';?>">
          <button type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Reset Kelas </button>
        </a>
        <a href="<?php echo base_url() . 'penjadwalan/generate_kelas';?>">
          <button type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Generate Kelas </button>
        </a>
      </div>
    </form>
    <!--End Search Form-->
  ...
  <div class="clearfix"></div>
    ...
    <div class="btn_add">
      <a href="<?=$url_proses_jadwal?>" <?=$display_buat_jadwal?>>
        <button class="btn btn-sm  btn-info"><i class="fa fa-plus-circle"></i> Generate jadwal </button>
      </a>
      <a href="<?=$url_list_jadwal?>" <?=$display_list_jadwal?>>
        <button class="btn btn-sm  btn-info"><i class="fa fa-folder"></i> Lihat jadwal </button>
      </a>
    </div>
        ...
        if (!empty($data)) {
          foreach ($data as $key => $value) {
            ...
            <tr>
              ...
              <td align="center">
                <a id="<?=$value['id']?>" href="<?=$url_pilih_guru?>" class="btn btn-xs  btn-info edit_guru"><i class="fa fa-edit"></i> Guru </a>
              </td>
