...
<div class="modal-footer">
	...
	<button type="submit" class="btn  btn-primary" id="submit_waktu">Pilih</button>
</div>
</form>
...
$("#submit_waktu" ).on( "click", function() {
	...
	row_data += "<td>"+jam+"</td>";
	row_data += "<td>";
	row_data += "<button type='button' class='btn btn-xs  btn-danger remove'><i class='fa fa-trash'></i> Hapus </button>";
